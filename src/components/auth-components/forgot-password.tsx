...
const ForgotPasswordComp = () => {
  return (
    <div className="container bg-white ">
      <img src={logo} alt="" width="120px" height="120px" className="ml-6 mt-10" />
      <div className="mx-auto w-10/12 sm:w-9/12 md:w-8/12 lg:w-5/12 mt-14">
        <div className="text-center mb-18">
          ...
          <div className="text-left mx-auto w-9/12 text-gray-400 uppercase ">
            ...
            <input
              ...
              className=" input-border rounded-md w-full h-14 pl-5 mt-3"
            />
          </div>
        </div>
        <div className="relative my-6 text-center">
          <hr className="border-[#8652a48f] w-full" />
          <p className="text-[#8652A4] text-sm px-4 bg-white absolute -top-3 left-56 sm:left-48">
            or sign up with
          </p>
